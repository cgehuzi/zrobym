...
const calc_arch = function () {
  ...
  const build_price_ranges = [
    [30 * 1.2, 30 * 1.2],
    [30 * 1.2, (3500 * 1.2) / 150],
    [(3500 * 1.2) / 150, (4000 * 1.2) / 200],
    [(4000 * 1.2) / 200, (5000 * 1.2) / 250],
    [(5000 * 1.2) / 250, (6000 * 1.2) / 350],
    [(6000 * 1.2) / 350, (7000 * 1.2) / 500],
    [(7000 * 1.2) / 500, (8000 * 1.2) / 1000],
    [(8000 * 1.2) / 1000, (9000 * 1.2) / 1500],
    [(9000 * 1.2) / 1500, (10000 * 1.2) / 3000],
    [(10000 * 1.2) / 3000, (13000 * 1.2) / 6000],
    [(13000 * 1.2) / 6000, (16000 * 1.2) / 12000],
    [(16000 * 1.2) / 12000, (20000 * 1.2) / 24000],
    [(20000 * 1.2) / 24000, 0.7 * 1.2],
    [0.7 * 1.2, 0.7 * 1.2],
  ];

  const build_price = build_on
    ? square_value * getPriceOfRange(build_square_ranges, build_price_ranges, square_value)
    : 0;
  ...
  const ingeneer_price_ranges = [
    [28 * 0.8, 28 * 0.8],
    [28 * 0.8, (3300 * 0.8) / 150],
    [(3300 * 0.8) / 150, (3800 * 0.8) / 200],
    [(3800 * 0.8) / 200, (4800 * 0.8) / 250],
    [(4800 * 0.8) / 250, (5800 * 0.8) / 350],
    [(5800 * 0.8) / 350, (6700 * 0.8) / 500],
    [(6700 * 0.8) / 500, (7700 * 0.8) / 1000],
    [(7700 * 0.8) / 1000, (8700 * 0.8) / 1500],
    [(8700 * 0.8) / 1500, (9600 * 0.8) / 3000],
    [(9600 * 0.8) / 3000, (12500 * 0.8) / 6000],
    [(12500 * 0.8) / 6000, (15000 * 0.8) / 12000],
    [(15000 * 0.8) / 12000, (19000 * 0.8) / 24000],
    [(19000 * 0.8) / 24000, 0.6 * 0.8],
    [0.6 * 0.8, 0.6 * 0.8],
  ];
